...
{
    /// <summary>
    /// Base class for implementing a long running <see cref="T:Microsoft.Extensions.Hosting.IHostedService" /> with restart ability.
    /// </summary>
    public abstract class ManualRestartBackgroundService : BackgroundService
    {
        ...
        /// Task can be canceled in any time by calling <see cref="TryReleaseDelay()"/>
        /// </summary>
        /// <param name="millisecondsDelay">The number of millisecond to wait before completing the return task, or -1 to wait indefinitely</param>
        /// <returns>A task that represents the time delay.</returns>
